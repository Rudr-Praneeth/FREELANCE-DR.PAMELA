...
const Doctors = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id="doctors"
      className="relative min-h-screen w-full bg-gradient-to-b from-white to-[#eaf4fb] flex items-center overflow-hidden py-12 md:py-24 lg:py-32"
    >
      <Gutters>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-6 items-start lg:items-center">
          ...
          <div className="lg:col-span-4 flex flex-col gap-1 z-20">
            <h2 className="font-sans font-bold text-4xl md:text-5xl text-black mb-8 uppercase tracking-tighter">
              Our{" "}
              <span className="font-serif italic font-normal text-[#4292C7]">
                Team
              </span>
            </h2>
            ...
            <div className="flex flex-col">
              {doctorData.map((doc, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`scan-line absolute left-0 top-0 h-full w-[2px] z-20 transition-colors duration-300 
                      ${
                        isActive
                          ? "bg-[#4292C7]"
                          : "bg-black/20 group-hover:bg-[#4292C7]"
                      }`}
                    />

                    <div
                      className={`line-glow absolute left-0 top-0 h-full w-[4px] blur-[4px] z-10 transition-opacity duration-300
                      ${
                        isActive
                          ? "opacity-100 bg-[#4292C7]"
                          : "opacity-0 group-hover:opacity-100 bg-[#4292C7]"
                      }`}
                    />
                    ...
                    <div className="row-content relative z-10">
                      ...
                      <p className="text-[9px] uppercase tracking-widest mt-1 font-bold text-[#4292C7]/80">
                        {doc.degrees}
                      </p>
                    </div>
                  </button>
          ...
          <div
            ref={cardRef}
            className="lg:col-span-8 h-auto lg:h-[65vh] bg-white 
            border border-black/10
            rounded-t-[40px] lg:rounded-t-none lg:rounded-tl-[80px] lg:rounded-bl-[80px] 
            shadow-xl overflow-hidden relative"
          >
            <div ref={fadeRef} className="h-full flex flex-col lg:flex-row">
              {/* Image */}
              <div className="w-full lg:w-[42%] h-[420px] sm:h-[520px] lg:h-full relative overflow-hidden bg-[#f5f9fc]">
                <img
              ...
              <div className="w-full lg:w-[58%] flex items-center">
                <div className="w-full px-6 md:px-10 lg:px-12 py-8 lg:py-10">
                  <span className="text-[#4292C7] text-[9px] uppercase tracking-[0.35em] mb-2 block font-bold">
                    {activeDoctor.role}
                  </span>

                  <h4 className="text-black text-2xl md:text-3xl lg:text-4xl font-serif italic mb-5 leading-snug">
                    {activeDoctor.name}
                  </h4>

                  <div className="space-y-5 max-w-md">
                    <div>
                      <h5 className="text-black/40 text-[8px] uppercase tracking-[0.25em] mb-1 font-bold">
                        Primary Specialty
                      </h5>
                      <p className="text-black text-xs leading-relaxed uppercase tracking-wide">
                    ...
                    <div className="pt-4 border-t border-black/10">
                      ...
                      <p className="text-[#4292C7] text-xl md:text-2xl font-serif italic">
                  ...
                  {/* subtle accent line */}
                  <div className="mt-6 h-[3px] w-16 bg-[#FFCA08]" />
                </div>
              </div>
            </div>
          </div>
