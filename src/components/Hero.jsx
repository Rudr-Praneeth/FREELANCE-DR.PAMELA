        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative z-10">
            ...
            <div className="pl-6 sm:pl-10">
              <p className="hero-pre text-[10px] tracking-[0.4em] uppercase text-[#0F172A]/50 font-bold mb-4">
                Pioneering Healthcare Since 1982
              </p>

              <h1 className="hero-heading font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tight text-[#1E40AF]">
                Advanced care,
                <br />
                <span className="italic font-light text-[#0EA5A4]">
                  guided by
                </span>
                <br />
                compassion
              ...
              <div className="hero-cta mt-8 flex flex-wrap items-center gap-6">
                ...
                <a
                  href="#services"
                  className="text-[12px] font-sans tracking-[0.2em] uppercase text-[#0F172A]/50 hover:text-[#0EA5A4] transition-colors duration-300"
                >
                  Our Departments →
                </a>
              </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative aspect-[16/10] w-full overflow-hidden rounded-sm border border-[#0F172A]/5 shadow-2xl">
              ...
              <img
                ...
                className="hero-img h-full w-full object-cover opacity-80"
              />
