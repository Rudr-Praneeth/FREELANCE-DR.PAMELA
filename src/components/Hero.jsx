...
const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className="relative min-h-[90vh] flex items-center pt-24 lg:pt-32 pb-16 overflow-hidden bg-gradient-to-b from-[#090A10] to-[#3B466B]"
    >
      <Gutters>
          ...
          <div className="relative z-10">
            ...
            <div className="pl-6 sm:pl-10">
              ...
              <h1 className="hero-heading font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tight text-white">
                Advanced care,
                <br />
                <span className="italic font-light text-[#7E878E]">
                  guided by
                </span>
                <br />
                compassion
              ...
              <div className="hero-cta mt-8 flex flex-wrap items-center gap-6">
                <a
                  href="#contact"
                  className="group relative overflow-hidden border border-white/20 px-6 py-3 text-white font-sans text-[12px] font-medium tracking-widest uppercase"
                >
                ...
                <a
                  href="#services"
                  className="text-[12px] font-sans tracking-[0.2em] uppercase text-white/40 hover:text-white transition-colors duration-300"
                >
                  Our Departments →
                </a>
              </div>
